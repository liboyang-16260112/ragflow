...
Beispiel: Eine 1 KB Nachricht mit 1024-dim Einbettung verwendet ~9 KB. Das Standardlimit von 5 MB fasst ~500 solcher Nachrichten.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Führen Sie einen Abruftest durch, um zu prüfen, ob FMoss-RAG die beabsichtigten Inhalte für das LLM wiederherstellen kann.',
      Parse: 'Analysieren',
      dataset: 'Datensatz',
      testing: 'Abruftest',
      files: 'Dateien',
...
`,
      ...
      useRaptorTip:
        'RAPTOR für Multi-Hop-Frage-Antwort-Aufgaben aktivieren. Details unter https://ragflow.io/docs/knowledge_compilation/built_in_templates_and_dedicated_configuration#tree.',
      prompt: 'Prompt',
      promptTip:
...
<p>Siehe https://ragflow.io/docs/dataset_configuration#basic-information für Details.</p>
      ...
      useGraphRagTip:
        'Erstellen Sie einen Wissensgraph über Dateiabschnitte der aktuellen Wissensbasis, um die Beantwortung von Fragen mit mehreren Schritten und verschachtelter Logik zu verbessern. Weitere Informationen finden Sie unter https://ragflow.io/docs/knowledge_compilation/built_in_templates_and_dedicated_configuration#graph.',
    ...
    chat: {
      ...
      betaError:
        'Bitte erwerben Sie zuerst einen FMoss-RAG-API-SCHLÜSSEL auf der Systemeinstellungsseite.',
      searching: 'Suche...',
      parsing: 'Analysiere',
      uploading: 'Hochladen',
