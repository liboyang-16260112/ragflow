  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'قم بإجراء اختبار استرجاع للتحقق مما إذا كان FMoss-RAG يمكنه استرداد المحتوى المقصود لـ LLM.',
      Parse: 'تحليل',
      dataset: 'مجموعة البيانات',
      ...
      rerankTip:
        'خياري. إذا تركت فارغة، فسوف يستخدم FMoss-RAG مجموعة من تشابه الكلمات الرئيسية الموزونة وتشابه جيب التمام المتجه الموزون؛ إذا تم تحديد نموذج إعادة الترتيب، فستحل درجة إعادة الترتيب المرجحة محل تشابه جيب تمام المتجه المرجح. يرجى العلم أن استخدام نموذج إعادة الترتيب سيؤدي إلى زيادة وقت استجابة النظام بشكل كبير. إذا كنت ترغب في استخدام نموذج إعادة الترتيب، فتأكد من استخدام أداة إعادة ترتيب SaaS؛ إذا كنت تفضل نموذج إعادة الترتيب المنشور محليًا، فتأكد من بدء تشغيل FMoss-RAG باستخدام docker-compose-gpu.yml.',
      topK: 'توب ك',
      topKTip:
    ...
    chat: {
      ...
      betaError:
        'يرجى الحصول على مفتاح FMoss-RAG API من صفحة إعدادات النظام أولاً.',
