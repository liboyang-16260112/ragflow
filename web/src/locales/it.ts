...
Esempio: un messaggio di 1 KB con embedding a 1024 dimensioni usa ~9 KB. Il limite predefinito di 5 MB contiene ~500 messaggi di questo tipo.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Esegui un test di recupero per verificare se FMoss-RAG riesce a recuperare il contenuto previsto per il LLM.',
      Parse: 'Analizza',
      dataset: 'Dataset',
...
`,
    ...
    knowledgeConfiguration: {
      ...
      tableColumnModeAutoDescription:
        'Tutte le colonne sono incluse nel testo del chunk e memorizzate come metadati (predefinito FMoss-RAG).',
...
**Regole essenziali:**
  ...
  - **Considera sempre** l'intera cronologia della conversazione.`,
      ...
      **Regole essenziali:**
      ...
      betaError:
        'Per favore acquisisci prima una chiave API FMoss-RAG dalla pagina Impostazioni di sistema.',
