export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      uploadDescription:
        "Prise en charge du téléversement unique ou en lot. Pour FMoss-RAG en local : 1 Go max par téléversement, jusqu'à 32 fichiers. Pour cloud.ragflow.io : 10 Mo max par fichier uploadDescription128 fichiers au total.",
      chunk: 'Segment',
      bulk: 'En masse',
      cancel: 'Annuler',
      ...
      retrievalTestingDescription:
        'Effectuez un test de récupération pour vérifier si FMoss-RAG peut retrouver le contenu pertinent pour le LLM.',
      Parse: 'Analyser',
...
`,
      ...
      tableColumnModeAutoDescription:
        'Toutes les colonnes sont incluses dans le texte du segment et stockées comme métadonnées (par défaut FMoss-RAG).',
...
`,
    ...
    chat: {
      ...
      betaError:
        "Veuillez d'abord obtenir une clé API FMoss-RAG depuis la page Paramètres système.",
...
**Règles essentielles :**
  ...
  - **Tenez toujours compte** de l'historique complet de la conversation.`,
    ...
    setting: {
      ...
      embeddingModel: "Modèle d'embedding",
      embeddingModelTip:
        "Le modèle d'embedding par défaut pour chaque base de connaissances nouvellement créée. Si vous ne trouvez pas de modèle d'embedding dans la liste déroulante, vérifiez si vous utilisez l'édition FMoss-RAG slim (qui n'inclut pas les modèles d'embedding) ou consultez https://ragflow.io/docs/dev/supported_models pour voir si votre fournisseur de modèle supporte ce modèle.",
