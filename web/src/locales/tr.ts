...
Örnek: 1024 boyutlu embedding ile 1 KB'lık bir mesaj ~9 KB kullanır. 5 MB varsayılan sınır ~500 mesaj tutar.`,
    ...
    knowledgeDetails: {
      ...
      rerankTip: `İsteğe bağlı. Boş bırakılırsa FMoss-RAG ağırlıklı anahtar kelime benzerliği ve ağırlıklı vektör kosinüs benzerliğinin kombinasyonunu kullanır; yeniden sıralama modeli seçilirse ağırlıklı yeniden sıralama puanı ağırlıklı vektör kosinüs benzerliğinin yerini alır. Yeniden sıralama modeli kullanmanın sistemin yanıt süresini önemli ölçüde artıracağını unutmayın.`,
      topK: 'Top-K',
...
`,
    ...
    knowledgeConfiguration: {
      ...
      tableColumnModeAutoDescription:
        'Tüm sütunlar parça metnine dahil edilir ve meta veri olarak saklanır (FMoss-RAG varsayılanı).',
...
**Temel Kurallar:**
  ...
  - **Her zaman** konuşma geçmişinin tamamını göz önünde bulundurun.`,
    ...
    setting: {
      ...
      webdavCaCertPathTip:
        'İsteğe bağlı: FMoss-RAG konteynerinin içine bağlanmış bir CA sertifika paketinin yolu.',
