export default {
  translation: {
    ...
    login: {
      ...
      continue: 'Continue',
      heroTitle: 'FMoss intelligent knowledge augmentation engine',
      heroSubtitle: 'Connecting unstructured data to precise retrieval for LLMs',
...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Conduct a retrieval test to check if FMoss-RAG can recover the intended content for the LLM.',
      Parse: 'Parse',
      dataset: 'Dataset',
      ...
      testingDescription:
        'Conduct a retrieval test to check if FMoss-RAG can recover the intended content for the LLM. If you have adjusted the default settings, such as keyword similarity weight or similarity threshold, to achieve the optimal results, be aware that these changes will not be automatically saved. You must apply them to your chat assistant settings or the Retrieval agent component settings.',
      similarityThreshold: 'Similarity threshold',
...
`,
    ...
    knowledgeConfiguration: {
      ...
      tableColumnModeAutoDescription:
        'All columns are included in chunk text and stored as metadata (FMoss-RAG default).',
...
**Essential Rules:**
  ...
  - **Always consider** the entire conversation history.`,
      ...
      **Essential Rules:**
      ...
      betaError:
        'Please acquire a FMoss-RAG API Key from the System Settings page first.',
      searching: 'Searching...',
      parsing: 'Parsing',
      uploading: 'Uploading',
...
Example: Virtual Hosted Style`,
      ...
      webdavCaCertPathTip:
        'Optional: Path to a CA certificate bundle mounted inside the FMoss-RAG container.',
      ...
      sitemapUserAgentTip:
        'User-Agent header sent with every request. Leave empty to use FMoss-RAG-SitemapConnector/1.0.',
      sitemapBatchSizeTip:
        'Number of pages fetched and sent to FMoss-RAG per batch.',
      ...
      embeddingModelTip:
        'The default embedding model for each newly created dataset. If you cannot find an embedding model from the dropdown, check if you are using FMoss-RAG slim edition (which does not include embedding models) or check https://ragflow.io/docs/dev/supported_models to see if your model provider supports this model.',
      img2txtModel: 'VLM',
      img2txtModelTip:
